 ...
 * read an abbreviation. Agencies we have no artwork for fall back to a large,
 * high-contrast text badge rather than a meaningless icon.
 */
...
<template>
  <span
    :class="[
      ...
      'inline-flex shrink-0 items-center justify-center overflow-hidden rounded-lg border border-default',
      logo ? 'bg-white p-1.5' : 'bg-elevated',
    ]"
  >
    <img
      v-if="logo"
