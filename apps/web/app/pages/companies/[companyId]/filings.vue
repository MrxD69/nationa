...
<template>
  <div class="space-y-6">
    ...
    >
      <template #actions>
        ...
        <UButton
          ...
          :label="t('filings.actions.newDraft')"
    ...
    <div class="mx-auto grid w-full max-w-6xl gap-6 lg:grid-cols-[minmax(0,20rem)_minmax(0,1fr)]">
      <section class="min-w-0 space-y-3 print:hidden">
        <SectionHeader :title="t('filings.list.title')" :count="filings.length" level="2" />
        <FilingList
          :items="filings"
          :loading="loading"
      ...
      <aside class="hidden min-w-0 lg:block">
        <div class="lg:sticky lg:top-20 space-y-4">
          <EmptyState
            ...
            size="sm"
            icon="i-tabler-file-invoice"
            :title="t('filings.list.select')"
            :description="t('filings.list.selectHint')"
            class="print:hidden"
          />
          ...
          <div v-else-if="detail" class="space-y-4">
            ...
            <div
              v-if="inviteOpen"
              class="flex flex-wrap items-end gap-2 border-y border-default py-3 print:hidden"
            >
