...
const faqItems = computed(() => [
  { label: t("help.faq.q1"), content: t("help.faq.a1") },
  { label: t("help.faq.q2"), content: t("help.faq.a2") },
  { label: t("help.faq.q3"), content: t("help.faq.a3") },
  { label: t("help.faq.q4"), content: t("help.faq.a4") },
]);
</script>
